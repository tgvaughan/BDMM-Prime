...
Sometimes you may not know to which type a tip should be assigned.  In this case
you can set the type to a "?" which indicates that the type is unknown. In this
case the phylodynamic likelihood will be evaluated under the assumption that type
information for this tip is unavailable.

Beware that designating all of your tip types as unknown can easily
