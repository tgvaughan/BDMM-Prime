...
While plotting all of the trajectories in this way can be interesting, it's often
more useful to display precise credible intervals for the population sizes through
time, similar to what's often used to visualize the results of Bayesian skyline plot
analyses.
