...
- =typeSet= (=TypeSet=, required) :: 
  Type set specifying model types.  (This is used to label stastics
...
in the skyline simultanouesly, this introduces more elements in the
...
two elements of the input =parameter= posess the identical value 1.237, those
...
Finally, BDMM-Prime also provdies the following class for initializing
