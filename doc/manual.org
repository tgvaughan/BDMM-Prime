...
best fit the birth-death dynamics on this scale.  These effects are
made very obvious by the population trajectory posteriors, and it's
important to keep the possibility of these kinds of effects in mind
when interpreting multi-type birth-death results and phylodynamic
inference results in general, even when applied at smaller scales.
