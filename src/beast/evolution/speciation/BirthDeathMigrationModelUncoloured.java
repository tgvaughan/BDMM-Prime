...
public class BirthDeathMigrationModelUncoloured extends PiecewiseBirthDeathSamplingDistribution {
	...
	public Input<Boolean> useRKInput =
			new Input<>("useRK", "Use fixed step size Runge-Kutta with 1000 steps.", true);
	...
	void setupIntegrators(){   // set up ODE's and integrators
		...
		P = new p0_ODE(birth, (birthAmongDemes ? b_ij : null), death,psi,M, n, totalIntervals, times, 0, useSmallNumbers.get());
		PG = new p0ge_ODE(birth, (birthAmongDemes ? b_ij : null), death,psi,M, n, totalIntervals, T, times, P, maxEvaluations.get(), false, useSmallNumbers.get());
